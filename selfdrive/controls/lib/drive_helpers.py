...
def get_lag_adjusted_curvature(CP, v_ego, psis, curvatures, curvature_rates, distances, personal_tune):
  ...
  average_curvature_desired = psi / distance if personal_tune else psi / (v_ego * delay)

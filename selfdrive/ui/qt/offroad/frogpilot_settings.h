...
ParamControllerInt(ConditionalExperimentalModeSpeed, "ConditionalExperimentalModeSpeed", "   Experimental Mode Below (No Lead)", "Switch to 'Experimental Mode' below this speed when there is no lead vehicle.", "../assets/offroad/icon_blank.png",
...
ParamControllerInt(ConditionalExperimentalModeSpeedLead, "ConditionalExperimentalModeSpeedLead", "   Experimental Mode Below (Lead)", "Switch to 'Experimental Mode' below this speed when there is a lead vehicle.", "../assets/offroad/icon_blank.png",
...
ParamControllerInt(PathEdgeWidth, "PathEdgeWidth", "   Path Edge Width", "Customize the path edge width that displays current driving statuses. Default is 20% of the total path.\n\nBlue = Always On Lateral\nOrange = Experimental Mode Active\nYellow = Conditional Experimental Mode Overriden", "../assets/offroad/icon_blank.png",

...
def get_frogpilot_params():
  params = Params()
  keys = [
    "FrogTheme", "FrogColors", "FrogIcons", "FrogSignals", "FrogSounds", "AdjustableFollowDistance", "AlwaysOnLateral", "Compass", "ConditionalExperimentalMode", 
    ...
    "MuteSystemOverheat", "NudgelessLaneChange", "LaneDetection", "OneLaneChange", "NumericalTemp", "PersonalTune", "ExperimentalPersonalTune", "RotatingWheel", 
    "ScreenBrightness", "Sidebar", "SilentMode", "SteeringWheel", "WideCameraDisable"
  ]

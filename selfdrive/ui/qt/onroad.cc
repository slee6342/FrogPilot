...
void AnnotatedCameraWidget::drawStatusBar(QPainter &p) {
  ...
  QString statusText = !is_cruise_set ? "Conditional Experimental Mode ready" :
                      (conditionalStatus == 1 && steeringWheelCar ? "Conditional Experimental Mode overridden. Double press the \"LKAS\" button to revert" :
                       conditionalStatus == 2 && steeringWheelCar ? "Experimental Mode manually activated. Double press the \"LKAS\" button to revert" :
